export default function PaymentAmount() {
  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow-sm">
      <div className="flex justify-between text-center align-middle font-[Pretendard] text-[16px] font-semibold">
        <div>결제예정금액</div>
        <div>{expectedAmount.toLocaleString()}원</div>
      </div>
      <div className="mt-3 border-t-1 border-neutral-300 pt-3">
        <div className="flex justify-between pb-2 text-center align-middle font-[Pretendard] text-[15px] font-semibold">
          <div>총 금액</div>
          <div>{totalAmount.toLocaleString()}원</div>
        </div>
        <div className="flex justify-between text-center align-middle font-[Pretendard] text-[13px] font-normal text-neutral-500">
          <div>메뉴 금액</div>
